 ...
 */
package com.ladzi.web;

import com.ladzi.model.Arithmetic;
import com.ladzi.model.Impl.ArithmeticCalculator;
...
public class RequestHandlerServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        Arithmetic calculate = new ArithmeticCalculator();
        calculate.setOperands(num1, num2);
        calculate.setOperation(operation);
        String answer = calculate.getAnswer();
        
        request.setAttribute("answer", answer);
        
        RequestDispatcher resDispatcher = request.getRequestDispatcher("display.jsp");
